# Bitgert (Brise Chain) Token Creation Tool

A simple frontend tool to create tokens on the Bitgert (Brise Chain) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Bitgert-Brise-Chain-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Bitgert (Brise Chain) Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Bitgert-Brise-Chain-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Bitgert (Brise Chain) wallet address for receiving fees. Also set fee in BRISE that you want to charge
